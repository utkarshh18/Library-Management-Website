...
<body>
  ...
  <div class="h"> <a href="catalogue.php">Books</a></div>
...
<?php
  ...
  {
    mysqli_query($db,"UPDATE  `issue_book` SET  `approve` =  '$_POST[approve]', `issue` =  '$_POST[issue]', `return_b` =  '$_POST[return]' WHERE username='$_SESSION[name]' and bid='$_SESSION[bid]';");
